...
list. The hacker made off with the SSL certificates for various sites including Gmail, Yahoo Mail, Hotmail.  \citep{comodohack}
This would allow the hacker to preform Man-in-the-Middle (MitM) attacks on the sites
and was then able to read the site user's emails.  This illustrates the vulnerability
