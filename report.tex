...
\tikzstyle{notary} = [rectangle, draw, text centered, text width=4em, fill=blue!20]
\tikzstyle{user}   = [rectangle, draw, text centered, text width=4em, fill=green!20]
\tikzstyle{server} = [rectangle, draw, text centered, text width=4em, fill=red!20]
