...
trust. The system works by checking the SSL certificate signature the users are
given from the server against the SSL certificate signatures that the users'
