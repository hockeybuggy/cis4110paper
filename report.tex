...
compromised in the past, allowing successful impersonation
...
list and the hacker made off with the SSL certificates
for various sites including Gmail, Yahoo Mail, Hotmail.  \citep{comodohack}
This would allow the hacker to preform M attacks on the sites
